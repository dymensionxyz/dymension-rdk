...
type Params struct {
	...
	Blockmaxgas uint32 `protobuf:"varint,3,opt,name=blockmaxgas,proto3" json:"blockmaxgas,omitempty"`
	// maximum allowed block size
	Blockmaxsize uint32 `protobuf:"varint,4,opt,name=blockmaxsize,proto3" json:"blockmaxsize,omitempty"`
}
...
func (m *Params) GetBlockmaxgas() uint32 {
	if m != nil {
...
var fileDescriptor_c7f89f13f4d953f6 = []byte{
	...
	0x7a, 0x7e, 0x7a, 0x3e, 0x58, 0x81, 0x3e, 0x88, 0x05, 0x51, 0xab, 0x54, 0xc1, 0xc5, 0x16, 0x00,
	...
	0x84, 0x71, 0x85, 0x14, 0xb8, 0xb8, 0x93, 0x72, 0xf2, 0x93, 0xb3, 0x73, 0x13, 0x2b, 0xd2, 0x13,
	0x8b, 0x25, 0x98, 0x15, 0x18, 0x35, 0x78, 0x83, 0x90, 0x85, 0x84, 0x94, 0xb8, 0x78, 0x60, 0xdc,
	0xe2, 0xcc, 0xaa, 0x54, 0x09, 0x16, 0xb0, 0x12, 0x14, 0x31, 0xa7, 0xd0, 0x13, 0x8f, 0xe4, 0x18,
	0x2f, 0x3c, 0x92, 0x63, 0x7c, 0xf0, 0x48, 0x8e, 0x71, 0xc2, 0x63, 0x39, 0x86, 0x0b, 0x8f, 0xe5,
	0x18, 0x6e, 0x3c, 0x96, 0x63, 0x88, 0xb2, 0x4e, 0xcf, 0x2c, 0xc9, 0x28, 0x4d, 0xd2, 0x4b, 0xce,
	0xcf, 0xd5, 0x4f, 0xa9, 0xcc, 0x4d, 0xcd, 0x03, 0xd9, 0x5a, 0x51, 0x59, 0x85, 0xe0, 0xe8, 0x16,
	0xa5, 0x64, 0xeb, 0x57, 0xe8, 0xa3, 0x86, 0x01, 0xd8, 0x9b, 0x49, 0x6c, 0x60, 0x7f, 0x19, 0x03,
	0x02, 0x00, 0x00, 0xff, 0xff, 0x3f, 0xd1, 0x9d, 0x26, 0x21, 0x01, 0x00, 0x00,
}
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Blockmaxgas |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
