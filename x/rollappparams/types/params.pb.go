...
type Params struct {
	...
	Blockmaxbytes uint32 `protobuf:"varint,3,opt,name=blockmaxbytes,proto3" json:"blockmaxbytes,omitempty"`
}
...
func (m *Params) GetBlockmaxbytes() uint32 {
	if m != nil {
...
var fileDescriptor_c7f89f13f4d953f6 = []byte{
	...
	0x7a, 0x7e, 0x7a, 0x3e, 0x58, 0x81, 0x3e, 0x88, 0x05, 0x51, 0xab, 0x14, 0xc1, 0xc5, 0x16, 0x00,
	...
	0x84, 0x71, 0x85, 0x54, 0xb8, 0x78, 0x93, 0x72, 0xf2, 0x93, 0xb3, 0x73, 0x13, 0x2b, 0x92, 0x2a,
	0x4b, 0x52, 0x8b, 0x25, 0x98, 0x15, 0x18, 0x35, 0x78, 0x83, 0x50, 0x05, 0x9d, 0x42, 0x4f, 0x3c,
	0x92, 0x63, 0xbc, 0xf0, 0x48, 0x8e, 0xf1, 0xc1, 0x23, 0x39, 0xc6, 0x09, 0x8f, 0xe5, 0x18, 0x2e,
	0x3c, 0x96, 0x63, 0xb8, 0xf1, 0x58, 0x8e, 0x21, 0xca, 0x3a, 0x3d, 0xb3, 0x24, 0xa3, 0x34, 0x49,
	0x2f, 0x39, 0x3f, 0x57, 0x3f, 0xa5, 0x32, 0x37, 0x35, 0x0f, 0x64, 0x6a, 0x45, 0x65, 0x15, 0x82,
	0xa3, 0x5b, 0x94, 0x92, 0xad, 0x5f, 0xa1, 0x8f, 0xea, 0x47, 0xb0, 0x37, 0x92, 0xd8, 0xc0, 0xee,
	0x36, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x3b, 0x0c, 0xec, 0x26, 0x01, 0x01, 0x00, 0x00,
}
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Blockmaxbytes |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
