...
import (
	...
	rdk "github.com/dymensionxyz/dymension-rdk/x/genutil"
	rdktypes "github.com/dymensionxyz/dymension-rdk/x/genutil/types"
)
...
func CollectGenTxsCmd(genBalIterator types.GenesisBalancesIterator, defaultNodeHome string) *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, _ []string) error {
			...
			genDoc, err := rdktypes.GenesisDocFromFile(config.GenesisFile())
			if err != nil {
			...
			appMessage, err := rdk.GenAppStateFromConfig(cdc,
				clientCtx.TxConfig,
