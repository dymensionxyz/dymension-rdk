...
// source: dymensionxyz/epochs/types/genesis.proto
...
func (*EpochInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_dc7b3934afe1c6aa, []int{0}
}
...
func (*GenesisState) Descriptor() ([]byte, []int) {
	return fileDescriptor_dc7b3934afe1c6aa, []int{1}
}
...
func init() {
	proto.RegisterType((*EpochInfo)(nil), "dymensionxyz.epochs.types.EpochInfo")
	proto.RegisterType((*GenesisState)(nil), "dymensionxyz.epochs.types.GenesisState")
}

func init() {
	proto.RegisterFile("dymensionxyz/epochs/types/genesis.proto", fileDescriptor_dc7b3934afe1c6aa)
}

var fileDescriptor_dc7b3934afe1c6aa = []byte{
	// 472 bytes of a gzipped FileDescriptorProto
	,
}
