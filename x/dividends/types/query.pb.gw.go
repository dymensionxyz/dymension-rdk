...
var (
	pattern_Query_GaugeByID_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"rollapp", "dividends", "gauge_by_id", "id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Gauges_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"rollapp", "dividends", "gauges"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"rollapp", "dividends", "params"}, "", runtime.AssumeColonVerbOpt(false)))
)
