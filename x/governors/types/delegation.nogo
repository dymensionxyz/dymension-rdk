...
var _ stakingtypes.DelegationI = Delegation{}
...
//
//nolint:interfacer
func NewDelegation(delegatorAddr sdk.AccAddress, GovernorAddr sdk.ValAddress, shares sdk.Dec) Delegation {
	return Delegation{
		DelegatorAddress: delegatorAddr.String(),
		ValidatorAddress: GovernorAddr.String(),
		Shares:           shares,
	}
}
...
func (d Delegation) GetGovernorAddr() sdk.ValAddress {
...
func NewUnbondingDelegation(
	delegatorAddr sdk.AccAddress, GovernorAddr sdk.ValAddress,
...
func NewDelegationResp(
	delegatorAddr sdk.AccAddress, GovernorAddr sdk.ValAddress, shares sdk.Dec, balance sdk.Coin,
) DelegationResponse {
	return DelegationResponse{
		Delegation: NewDelegation(delegatorAddr, GovernorAddr, shares),
		Balance:    balance,
	}
}
...
func NewRedelegationResponse(
	delegatorAddr sdk.AccAddress, GovernorSrc, GovernorDst sdk.ValAddress, entries []RedelegationEntryResponse,
) RedelegationResponse {
	return RedelegationResponse{
		Redelegation: Redelegation{
			DelegatorAddress:    delegatorAddr.String(),
			ValidatorSrcAddress: GovernorSrc.String(),
			ValidatorDstAddress: GovernorDst.String(),
		},
		Entries: entries,
	}
}
