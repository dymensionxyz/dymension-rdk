...
// NewCommissionRates returns an initialized Governor commission rates.
...
// NewCommission returns an initialized Governor commission.
...
// NewCommissionWithTime returns an initialized Governor commission with a specified
