...
// Implements GovernorSet interface
var _ types.GovernorSet = Keeper{}
...
// Set the governor hooks
func (k *Keeper) SetHooks(sh types.StakingHooks) *Keeper {
	if k.hooks != nil {
		panic("cannot set governor hooks twice")
	}
...
// Load the last total governors power.
...
// Set the last total governors power.
