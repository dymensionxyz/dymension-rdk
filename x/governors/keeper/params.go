...
// MaxGovernors - Maximum number of governors
func (k Keeper) MaxGovernors(ctx sdk.Context) (res uint32) {
	k.paramstore.Get(ctx, types.KeyMaxGovernors, &res)
	return
}
...
// MinCommissionRate - Minimum governor commission rate
