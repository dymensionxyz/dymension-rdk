...
require (
	...
	github.com/dymensionxyz/dymint v0.4.0-beta.0.20230521114348-5a130fca4d8e
...
require (
	...
	github.com/dymensionxyz/cosmosclient v0.3.0-beta.0.20230514120937-449e9becd080 // indirect
